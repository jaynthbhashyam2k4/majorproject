"""fraud_detection_in_online_product_review  URL Configuration
...
from fraud_detection_in_online_product_review  import settings
...
urlpatterns = [
    ...
    url(r'^Detect_Product_Review_Type/$', remoteuser.Detect_Product_Review_Type, name="Detect_Product_Review_Type"),
    ...
    url(r'^Find_Detection_Product_Review_Type_Ratio/$', serviceprovider.Find_Detection_Product_Review_Type_Ratio, name="Find_Detection_Product_Review_Type_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Detection_Product_Review_Type/$', serviceprovider.View_Detection_Product_Review_Type, name="View_Detection_Product_Review_Type"),
