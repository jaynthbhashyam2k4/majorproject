...
ROOT_URLCONF = 'fraud_detection_in_online_product_review.urls'
...
WSGI_APPLICATION = 'fraud_detection_in_online_product_review.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'fraud_detection_in_online_product_review',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
